package com.stori.simulator.mq.producer.config;
...
public class DefaultProducerConfig {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(com.example.server.mq.config.DefaultProducerConfig.class);
